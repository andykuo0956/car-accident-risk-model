...
A1_traffic_accident_simple = gpd.read_file(
    "NTUDAC-Gogoro-Partnership-Project/car-accident-and-risk-model/rawData/traffic_accident_A1/A1_simple/A1_simple.shp")
A2_traffic_accident_simple = gpd.read_file(
    "NTUDAC-Gogoro-Partnership-Project/car-accident-and-risk-model/rawData/traffic_accident_A2/A2_simple/A2_simple.shp")
